...
import 'package:untitled/views/generalbusFlow/seatBooking.dart';
          ...
          children: [
            Stack(
              children: [
                ...
                Padding(
                  ...
                  child: CustomText(text: 'Route Plan',weight: FontWeight.w700,size: 20.sp,color: Colors.white,),
                )
              ],
            ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  CustomText(text: 'Complete route plan',weight: FontWeight.w900,size: 18.sp,),
                  SizedBox(width: 30.w,),
